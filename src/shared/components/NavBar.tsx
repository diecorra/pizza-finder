    ...
    <div className="fixed top-0 left-0 right-0 shadow-2xl z-10">
      <div className="bg-slate-900 flex justify-between items-center h-14 text-white w-screen">
        <ul className="flex items-center justify-center w-screen list-none gap-10 text-xs sm:text-base">
          ...
          <NavLink to="home" className="scale-100 hover:scale-125">
            HOME
          </NavLink>
          <NavLink to="lastreviews" className="scale-100 hover:scale-125">
            LAST REVIEWS
          </NavLink>
          <NavLink to="settings" className="scale-100 hover:scale-125">
            SETTINGS
          </NavLink>
        </ul>
      </div>
